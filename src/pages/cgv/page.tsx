      ...
      <section className="py-20 pt-40 container mx-auto px-4">
        <div className="max-w-4xl mx-auto glass-card p-10 rounded-2xl animate-fade-in">
          ...
          <p className="mb-6 text-muted-foreground">
            ...
            Meltech France et ses clients pour la création de sites web,
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                <br />– La maintenance inclut : corrections, support, mises à
                jour légères, monitoring serveur.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Le client est propriétaire du site livré. Meltech France
                conserve la propriété du code source non personnalisé
                (frameworks internes).
              </p>
            </div>
